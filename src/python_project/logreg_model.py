...
from utils.dataframe_utils import read_csv_file, filter_dataframe, write_to_excel
...
for group in groups:
    try:
        ...
        group_data['Predicted_Class_Group_AG'] = group_data['Predicted_Class_Group_AG'].astype('category')
...
for group in groups:
    ...
    logreg_model = LogisticRegression(max_iter=1000)  # Zwiększamy max_iter w razie potrzeby
