...
#%%
def create_multiple_bar_plot(data, ax=None, fill_missing: bool = True, **kwargs):
    """
...
#%%
def create_subplots(n_plots, n_cols=2, figsize=(30, 5)):
    """
...
def save_plot(fig, file_path: str) -> None:
    """
    Save a Plotly or Matplotlib plot to a file in the specified format and directory.
    ...
    - TypeError: If the provided figure is neither a Plotly nor a Matplotlib figure.
    ...
    if isinstance(fig, go.Figure):
        if file_extension == "html":
            ...
            fig.write_image(file_path, format=file_extension)
...
if __name__ == "__main__":
    ...
    output_file_path = current_working_directory / 'plots' / 'subplots_bar_plots.png'
    ...
    fig, axes = create_subplots(n_plots=4, n_cols=2, figsize=(12, 8))

    # Use create_multiple_bar_plot to create plots in each subplot
    create_multiple_bar_plot(data1, ax=axes[0],
                             plot_title="Plot 1",
    ...
    create_multiple_bar_plot(data2,
                             ax=axes[1],
                             plot_title="Plot 2",
    ...
    create_multiple_bar_plot(data3,
                             ax=axes[2],
                             plot_title="Plot 3",
                             legend_labels=["Series 1", "Series 2"],
                             bar_width = 0.20,
    ...
    create_multiple_bar_plot(data4,
                             ax=axes[3],
                             plot_title="Plot 4",
                             legend_labels=["Series 1", "Series 2"],
                             bar_width = 0.20,
    ...
    # Save plots to file
    save_plot(fig, file_path=output_file_path)